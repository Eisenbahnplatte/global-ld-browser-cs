...
export function getPredsAndObjects(store, subject){
  return store.match(DataFactory.namedNode(subject), undefined, undefined, undefined) 
}

export function getStoreSize(store){
  return store.countQuads(undefined, undefined, undefined, undefined)
}